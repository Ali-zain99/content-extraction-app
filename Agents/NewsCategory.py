...
def build_prompt():
    return """
You are given an image that contains different cateogies

Your task is to carefully analyze the image and extract the names listen.
...
# --------------------------
def crop_speakers(img, crop_box, save_path=r"C:\Users\ali.zain\Desktop\Content_Extraction\Files\NewsCategory.png"):
...
# Clean & Load JSON
# --------------------------
def load_clean_json(raw_text, save_path=r"C:\Users\ali.zain\Desktop\Content_Extraction\Files\NewsCategory.json"):
...
def main(pdf_path,API_KEY, website_url):
    ...
    # Step 2: Crop region
    cropped_path = crop_speakers(img, crop_box, save_path=r"C:\Users\ali.zain\Desktop\Content_Extraction\Files\NewsCategory.png")

    # Step 3: Extract speakers with Gemini
    raw_text = extract_speakers(cropped_path, api_key)

    # Step 4: Clean + Save JSON
    data = load_clean_json(raw_text, save_path=r"C:\Users\ali.zain\Desktop\Content_Extraction\Files\NewsCategory.json")
